...
{
    public class VBDeftypeStmt : VBBaseSingleLineStatement
    {
        /*
         * deftypeStmt
        ...
        internal VBDeftypeStmt(VB6CodeModelFactoryContext factoryContext) : base(factoryContext) { }
        ...
        internal override void BeforeVisitChild()
        {
            ...
            var m = new UnSupportedDefType(ParserContext.Start.Line, ParserContext.Start.Column);
